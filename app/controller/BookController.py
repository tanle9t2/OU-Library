...
import app
from app.dao import ActivityLogDAO
...
def borrow_book(book_id):
    ...
    msg_log, status_activity_log = ActivityLogDAO.create_activity_log(user_id, book_id, "NEW_REQUEST")
    ...
    if status_request == 201 and status_activity_log == 201:
        ...
        if status_request == 409 or status_activity_log != 409:
            flash("Bạn đang yêu cầu mượn sách này", "danger")
